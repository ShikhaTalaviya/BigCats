...
const FoundersDesk = () => {
  ...
  return (
    <section id="founders" className="py-12 md:py-20 px-4 md:px-6 max-w-[1400px] mx-auto" ref={ref}>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
        ...
        {/* Right - Founders */}
        <div className={`grid grid-cols-2 gap-4 md:gap-8 transition-all duration-800 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
          {/* Neha Kshatriya */}
          <div className="text-center">
            <div className="aspect-[3/4] overflow-hidden rounded-sm mb-3 md:mb-4">
              <img
            ...
            <h3 className="text-[#C9A84C] font-['Playfair_Display'] font-semibold text-[16px] md:text-[20px] mb-1">
              Neha Kshatriya
            </h3>
            <p className="text-[#777777] font-['Montserrat'] text-[10px] md:text-[12px] uppercase tracking-wide mb-2 md:mb-3">
              Founder
            </p>
